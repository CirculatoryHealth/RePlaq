...
Here we map genes and variants at the `r TRAIT_OF_INTEREST` locus to the single-cell and bulk transcriptomics carotid plaque data, and other plaque-derived traits. These are given in:

- `Variants.xlsx - sheet Variants`
- `Genes.xlsx`
...
# update list
gene_list <- read.xlsx(paste0(TARGET_loc, "/targets.xlsx"), sheet = "Genes")

variant_list <- read.xlsx(paste0(TARGET_loc, "/targets.xlsx"), sheet = "Variants")
# credset_list <- read.xlsx(paste0(TARGET_loc, "/Variants.xlsx"), sheet = "CredibleSet")
